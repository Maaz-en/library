...
class BookController extends Controller
{
    ...
    {
        $data = BookRent::select('u.u_id', 'u.firstname', 'u.lastname', 'u.email', 'b.b_id', 'b.book_name', 'b.author', 'br.issued_on', 'br.returned_on')
    ...
    public function issueBook(Request $request)
    {
        ...
        $already_issued = BookRent::where('u_id', $request->get('u_id'))
    ...
    public function returnBook(Request $request, $id)
    {
        ...
        $book = BookRent::whereNull('returned_on')
            ->find($id);
